...
{
    /// <inheritdoc />
    public partial class initMarkaz : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Manifacturing = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Workers",
                columns: new[] { "Id", "Age", "Bonus", "FirstName", "LastName", "Salary" },
                values: new object[,]
                {
                    { 1, 20, 0m, "ali", "ahmadi", 0m },
                    { 2, 21, 0m, "majid", "majidi", 0m },
                    { 3, 22, 0m, "farhad", "farhadi", 0m },
                    { 4, 23, 0m, "soheil", "soheily", 0m }
                });
